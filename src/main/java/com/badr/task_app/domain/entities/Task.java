...
public class Task {
    ...
    public Task(UUID id, String title, String description, String dueDate, TaskStatus status, TaskPriority priority, TaskList taskList, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.title = title;
